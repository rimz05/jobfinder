...
const Hero = () => {
  ...
  return (
    <div className='conatainer 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-4 rounded-xl'>
      ...
      <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex '>
        <div className='flex gap-10 justify-center lg:gap-16 flex-wrap'>
